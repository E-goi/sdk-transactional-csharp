...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AlertEmail :  IEquatable<AlertEmail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlertEmail" /> class.
        /// </summary>
        ...
        public AlertEmail(string alertTemplateName = default(string), string senderId = default(string), List<ToEmailAlertObject> to = default(List<ToEmailAlertObject>))
        {
            // to ensure "alertTemplateName" is required (not null)
            if (alertTemplateName == null)
            {
                throw new InvalidDataException("alertTemplateName is a required property for AlertEmail and cannot be null");
            }
            else
            {
            ...
            if (senderId == null)
            {
                throw new InvalidDataException("senderId is a required property for AlertEmail and cannot be null");
            }
            else
            {
            ...
            if (to == null)
            {
                throw new InvalidDataException("to is a required property for AlertEmail and cannot be null");
            }
            else
            {
                this.To = to;
        ...
        public List<ToEmailAlertObject> To { get; set; }
        ...
        {
            return this.Equals(input as AlertEmail);
        }

        /// <summary>
        /// Returns true if AlertEmail instances are equal
        /// </summary>
        /// <param name="input">Instance of AlertEmail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlertEmail input)
        {
            if (input == null)
                return false;
