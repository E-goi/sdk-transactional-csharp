...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ToMultiChannelObject :  IEquatable<ToMultiChannelObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ToMultiChannelObject" /> class.
        /// </summary>
        ...
        public ToMultiChannelObject(string email = default(string), string phone = default(string), List<string> mergeTags = default(List<string>))
        {
            this.Email = email;
            this.Phone = phone;
        ...
        {
            return this.Equals(input as ToMultiChannelObject);
        }

        /// <summary>
        /// Returns true if ToMultiChannelObject instances are equal
        /// </summary>
        /// <param name="input">Instance of ToMultiChannelObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ToMultiChannelObject input)
        {
            if (input == null)
                return false;
