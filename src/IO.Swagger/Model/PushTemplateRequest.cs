...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PushTemplateRequest :  IEquatable<PushTemplateRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PushTemplateRequest" /> class.
        /// </summary>
        ...
        /// <param name="customData">The text body of the message. (default to &quot;1&quot;).</param>
        /// <param name="templateName">The name of the template. (required).</param>
        public PushTemplateRequest(string subject = default(string), string textBody = default(string), AppIdEnum? appId = AppIdEnum.Unicode, string customData = "1", string templateName = default(string))
        {
            // to ensure "subject" is required (not null)
            if (subject == null)
            {
                throw new InvalidDataException("subject is a required property for PushTemplateRequest and cannot be null");
            }
            else
            {
            ...
            if (textBody == null)
            {
                throw new InvalidDataException("textBody is a required property for PushTemplateRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("templateName is a required property for PushTemplateRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as PushTemplateRequest);
        }

        /// <summary>
        /// Returns true if PushTemplateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PushTemplateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PushTemplateRequest input)
        {
            if (input == null)
                return false;
