...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MobileAppRequest :  IEquatable<MobileAppRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MobileAppRequest" /> class.
        /// </summary>
        ...
        public MobileAppRequest(string name = default(string), bool? sandbox = default(bool?), string certificate = default(string), string password = default(string), string authKey = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for MobileAppRequest and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (sandbox == null)
            {
                throw new InvalidDataException("sandbox is a required property for MobileAppRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as MobileAppRequest);
        }

        /// <summary>
        /// Returns true if MobileAppRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MobileAppRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MobileAppRequest input)
        {
            if (input == null)
                return false;
