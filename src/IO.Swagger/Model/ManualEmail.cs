...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ManualEmail :  IEquatable<ManualEmail>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ManualEmail" /> class.
        /// </summary>
        ...
        /// <param name="htmlBody">The html version of the body of the message..</param>
        /// <param name="textBody">The text version of the body of the message..</param>
        /// <param name="openTracking">The option to track if the message is opened. (default to false).</param>
        /// <param name="clickTracking">The option to track if the message is clicked. (default to false).</param>
        ...
        public ManualEmail(string domain = default(string), string senderId = default(string), string senderName = default(string), List<string> to = default(List<string>), List<string> cc = default(List<string>), List<string> bcc = default(List<string>), string replyToId = default(string), string subject = default(string), string htmlBody = default(string), string textBody = default(string), bool? openTracking = false, bool? clickTracking = false, List<AttachmentRequest> attachment = default(List<AttachmentRequest>), List<string> mergeTags = default(List<string>), string customData = default(string), PriorityEnum? priority = PriorityEnum.NonUrgent, bool? registered = false, HeaderOptionsRequest header = default(HeaderOptionsRequest), string group = "default")
        {
            // to ensure "senderId" is required (not null)
            if (senderId == null)
            {
                throw new InvalidDataException("senderId is a required property for ManualEmail and cannot be null");
            }
            else
            {
            ...
            if (to == null)
            {
                throw new InvalidDataException("to is a required property for ManualEmail and cannot be null");
            }
            else
            {
                this.To = to;
            ...
            if (subject == null)
            {
                throw new InvalidDataException("subject is a required property for ManualEmail and cannot be null");
            }
            else
            {
            ...
            // use default value if no "openTracking" provided
            ...
            // use default value if no "clickTracking" provided
        ...
        /// </summary>
        /// <value>The html version of the body of the message.</value>
        ...
        /// </summary>
        /// <value>The text version of the body of the message.</value>
        ...
        /// </summary>
        /// <value>The option to track if the message is opened.</value>
        ...
        /// </summary>
        /// <value>The option to track if the message is clicked.</value>
        ...
        {
            return this.Equals(input as ManualEmail);
        }

        /// <summary>
        /// Returns true if ManualEmail instances are equal
        /// </summary>
        /// <param name="input">Instance of ManualEmail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ManualEmail input)
        {
            if (input == null)
                return false;
