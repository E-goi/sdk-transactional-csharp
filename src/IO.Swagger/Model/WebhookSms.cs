...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class WebhookSms :  IEquatable<WebhookSms>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as WebhookSms);
        }

        /// <summary>
        /// Returns true if WebhookSms instances are equal
        /// </summary>
        /// <param name="input">Instance of WebhookSms to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookSms input)
        {
            if (input == null)
                return false;
