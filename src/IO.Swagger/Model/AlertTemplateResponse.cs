...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AlertTemplateResponse :  IEquatable<AlertTemplateResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlertTemplateResponse" /> class.
        /// </summary>
        ...
        /// <param name="channel">the text version of the message..</param>
        public AlertTemplateResponse(string name = default(string), int? interval = default(int?), int? maxAttempts = default(int?), string templateId = default(string), string subject = default(string), string htmlBody = default(string), string textBody = default(string), string channel = default(string))
        {
            // to ensure "interval" is required (not null)
            if (interval == null)
            {
                throw new InvalidDataException("interval is a required property for AlertTemplateResponse and cannot be null");
            }
            else
            {
            ...
            if (maxAttempts == null)
            {
                throw new InvalidDataException("maxAttempts is a required property for AlertTemplateResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as AlertTemplateResponse);
        }

        /// <summary>
        /// Returns true if AlertTemplateResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AlertTemplateResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlertTemplateResponse input)
        {
            if (input == null)
                return false;
