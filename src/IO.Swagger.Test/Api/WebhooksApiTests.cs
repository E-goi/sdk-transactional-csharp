...
namespace IO.Swagger.Test
{
    ...
    public class WebhooksApiTests
    {
        ...
        public void AddWebHookTest()
        {
            ...
            //Body1 body = null;
            //var response = instance.AddWebHook(body);
            //Assert.IsInstanceOf<WebhookIdResponse> (response, "response is WebhookIdResponse");
        }
        /// <summary>
        /// Test ListWebHooks
        /// </summary>
        ...
        public void ListWebHooksTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string channel = null;
            //var response = instance.ListWebHooks(channel);
            //Assert.IsInstanceOf<List<GetWebhooksResponse>> (response, "response is List<GetWebhooksResponse>");
        }
        /// <summary>
        /// Test RemoveWebHook
        /// </summary>
        ...
        public void RemoveWebHookTest()
        {
            ...
            //string id = null;
            //string channel = null;
            //instance.RemoveWebHook(id, channel);
