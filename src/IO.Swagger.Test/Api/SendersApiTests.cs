...
namespace IO.Swagger.Test
{
    ...
    public class SendersApiTests
    {
        ...
        public void GetEmailSendersTest()
        {
            ...
            //var response = instance.GetEmailSenders();
            //Assert.IsInstanceOf<List<EmailSenderResponse>> (response, "response is List<EmailSenderResponse>");
        }
        /// <summary>
        /// Test GetSmsSenders
        /// </summary>
        [Test]
        public void GetSmsSendersTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.GetSmsSenders();
            //Assert.IsInstanceOf<List<SmsSenderResponse>> (response, "response is List<SmsSenderResponse>");
        }
    }
